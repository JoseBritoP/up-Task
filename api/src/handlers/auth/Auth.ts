import { GET,GETBYID,POSTREGISTER,GETCONFIRMACCOUNT,PUT,PATCH,DELETE,POSTLOGIN,REQUESTCODE,FORGETPASSWORD,VALIDATETOKEN, UPDATEPASSWORD, CHECKPASSWORD } from "./auth.functions"
